...
/* FPERSON_NAME_FK */
ALTER TABLE FRTHR_MODEL.FPERSON_NAME
  ADD CONSTRAINT FPERSON_NAME_FK 
  FOREIGN KEY ( FPERSON_ID, DataSet_ID ) 
  REFERENCES FRTHR_MODEL.FPERSON( FPERSON_ID, DataSet_ID );
...
ALTER TABLE FRTHR_MODEL.FSPECIMEN
  ...
  FOREIGN KEY ( FPROTOCOL_ID, DataSet_ID )
  REFERENCES FRTHR_MODEL.FPROTOCOL( FPROTOCOL_ID, DataSet_ID );

ALTER TABLE FRTHR_MODEL.FSPECIMEN
  ADD CONSTRAINT FSPECIMEN_FK4
  FOREIGN KEY ( FPROTOCOL_ID, DataSet_ID )
  REFERENCES FRTHR_MODEL.FPROTOCOL_CONSENT( FPROTOCOL_ID, DataSet_ID );

ALTER TABLE FRTHR_MODEL.FSPECIMEN
  ADD CONSTRAINT FSPECIMEN_FK5
  FOREIGN KEY ( FPROTOCOL_ID, DataSet_ID )
  REFERENCES FRTHR_MODEL.FPROTOCOL_DX( FPROTOCOL_ID, DataSet_ID );
...
/* FSPECIMEN_EXTID_FK */
ALTER TABLE FRTHR_MODEL.FSPECIMEN_EXTID
  ADD CONSTRAINT FSPECIMEN_EXTID_FK1
  FOREIGN KEY ( FSPECIMEN_ID, DataSet_ID )
  REFERENCES FRTHR_MODEL.FSPECIMEN( FSPECIMEN_ID, DataSet_ID);

/* FPROTOCOL_CONSENT_FK */
ALTER TABLE FRTHR_MODEL.FPROTOCOL_CONSENT
  ADD CONSTRAINT FPROTOCOL_CONSENT_FK1
  FOREIGN KEY ( FPROTOCOL_ID, DataSet_ID )
  REFERENCES FRTHR_MODEL.FPROTOCOL( FPROTOCOL_ID, DataSet_ID);

/* FPROTOCOL_DX_FK */
ALTER TABLE FRTHR_MODEL.FPROTOCOL_DX
  ADD CONSTRAINT FPROTOCOL_DX_FK1
  FOREIGN KEY ( FPROTOCOL_ID, DataSet_ID )
  REFERENCES FRTHR_MODEL.FPROTOCOL( FPROTOCOL_ID, DataSet_ID);
