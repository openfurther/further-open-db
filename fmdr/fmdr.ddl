...
*/
  ...
  -- Reset Value of ASSET_SEQ if necessary
  CREATE SEQUENCE FMDR.ASSET_SEQ
    MINVALUE 10000000 MAXVALUE 999999999
    INCREMENT BY 1 START WITH 10001053
    NOCACHE ORDER NOCYCLE;
...
(
  ...
  ASSET_TYPE_PROP_ID NUMBER NOT NULL,
...
(
  ...
  ASSET_ASSOC_ID NUMBER NOT NULL,
...
SELECT ASSET_NAMESPACE_ASSET_ID,
       ...
       ASSET_ACTIVATE_DT
  FROM ASSET_V
 WHERE ASSET_ID between 10000 and 99999
...
/* OR */
/*
create or replace view System_Asset_V
as
select * 
  from asset 
 where ASSET_ID between 10000 and 99999
