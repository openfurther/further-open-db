...
COMMENT ON COLUMN FMDR.ASSET_VERSION.ASSET_STATUS_ID IS 'Asset Status (1=Active?)';
...
COMMENT ON COLUMN FMDR.ASSET_VERSION.ASSET_PROPERTIES_XML IS 'Asset Properties in XML Format';
