...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_ASSET_LABEL" (P_ASSET_ID NUMBER) RETURN VARCHAR2 AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_ASSET_NAMESPACE_ID" ( p_asset_id number ) RETURN NUMBER AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_ASSET_NAMESPACE_LABEL" ( p_asset_id number ) RETURN VARCHAR2 AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_ASSET_PARENT" (P_ASSET_ID NUMBER) 
RETURN VARCHAR2 
AS
...
BEGIN
  ...
  SELECT LS_ASSET_ID
    INTO V_LS_ASSET_ID 
    FROM FMDR.ASSET_ASSOC
   WHERE ASSOC_ASSET_ID = 227
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_ASSET_TYPE_ID" ( p_asset_id number ) RETURN NUMBER AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_ASSET_TYPE_LABEL" ( p_asset_id number ) RETURN VARCHAR2 AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_ASSOC_PROPS_STRING" ( p_asset_assoc_id asset_assoc.asset_assoc_id%type ) RETURN VARCHAR2 AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_ATTR_NM_FROM_TAG" ( p_resource_id number, p_tag_nm varchar2, p_tag_val varchar2) RETURN VARCHAR2 AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_ATTR_OBJ_ID" ( p_attr_asset_id asset.asset_id%type ) RETURN asset.asset_id%type AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_DATA_ASSETS" ( p_obj_nm varchar2 ) RETURN SYS_REFCURSOR AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_DTS_NAMESPACE_LABEL" (P_NMSPC_ID NUMBER) RETURN VARCHAR2 AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_LOOKUP_LABEL" (P_LOOKUP_VALUE_ID NUMBER) RETURN VARCHAR2 AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_NEXT_ASSET_VERSION" ( p_asset_id asset.asset_id%type ) 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_RESOURCE_RESOURCE_ID" ( p_resource_id number, p_resource_type_id number ) RETURN number AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_RESOURCE_TYPE_LABEL" (P_RESOURCE_TYPE_ID NUMBER) RETURN VARCHAR2 AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."GET_VALUE_DOMAIN_NAMESPACE" ( p_asset_resource_id number, p_value_domain_name varchar2 ) RETURN VARCHAR2 AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "FMDR"."IS_ACTIVE_RESOURCE" ( p_resource_id number ) RETURN NUMBER AS
